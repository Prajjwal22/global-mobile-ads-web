...
export default function Services() {
  return (
    <section id="services" className="w-full h-[1055px] bg-primary text-white bg-[url('/blue-triangle.svg')] bg-no-repeat bg-left-bottom bg-clipPath bg-leftTriangle  mb-10">
